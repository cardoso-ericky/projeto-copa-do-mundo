    ...
    containerGrupos.classList.add('flex' , 'flex-row' , 'flex-wrap',
        ...
        <div class="grupo__selecoes>
            ...
            <div clas="selecoes__pais">
               ...
               alt="Bnadeira do ${grupo.selecoes[1]}">
            ...
            <div clas="selecoes__pais">
               ...
               alt="Bnadeira do ${grupo.selecoes[2]}">
            ...
            <div clas="selecoes__pais">
               ...
               alt="Bnadeira do ${grupo.selecoes[3]}">
